...
function Balancing_GetWeaponProbability(x, y)
    ...
    data[WeaponType.ChainGun] =             {p = 2.5}
    data[WeaponType.PointDefenseChainGun] = {p = 1.0}
    data[WeaponType.MiningLaser] =          {p = 1.5}
    data[WeaponType.RawMiningLaser] =       {d = 0.85, p = 1.5}
    data[WeaponType.SalvagingLaser] =       {p = 1.0}
    data[WeaponType.RawSalvagingLaser] =    {d = 0.85, p = 1.0}
