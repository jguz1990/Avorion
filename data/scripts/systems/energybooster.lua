...
function getTooltipLines(seed, rarity, permanent)
    ...
    if energy ~= 0 then
        ...
        table.insert(bonuses, {ltext = "Generated Energy"%_t, rtext = string.format("%+i%%", baseEnergy * 0.5 * 100), icon = "data/textures/icons/electric.png"})
    end
    ...
    if charge ~= 0 then
        ...
        table.insert(bonuses, {ltext = "Recharge Rate"%_t, rtext = string.format("%+i%%", baseCharge * 0.5 * 100), icon = "data/textures/icons/power-unit.png"})
    end
