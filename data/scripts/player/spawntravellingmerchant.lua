...
function initialize()
    ...
    Sector():broadcastChatMessage("${title} ${name}"%_t % ship, 0, "%s %s here. I'll be offering my services here for the next 15 minutes! Best merchandise in the quadrant!"%_t, ship.title, ship.name)
